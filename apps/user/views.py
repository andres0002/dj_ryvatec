...
from apps.user.forms import AdicionarUsuarioForm, UsuarioForm
    ...
    def post(self, request):
        ...
        if usuario != None and usuario.is_active:
            ...
            if cliente[0].rol == "AMD":
                return HttpResponseRedirect(reverse('user:administrator:home'))

            elif cliente[0].rol == "PRO":
                return HttpResponseRedirect(reverse('user:supplier:home'))

            elif cliente[0].rol == "TEC":
                return HttpResponseRedirect(reverse('user:technical:home'))
