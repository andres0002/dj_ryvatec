...
from apps.user.forms import UsuarioForm, DispositivoForm
...
class PerfilProveedor(LoginRequiredMixin, View):
    ...
    '''
    login_url = '/'
    template_name = 'supplier/perfil_proveedor.html'
...
class ListarDispositivos(LoginRequiredMixin, View):
    ...
    template_name = 'supplier/listar_dispositivos.html'
...
class AdicionarDispositivo(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = DispositivoForm
    template_name = 'supplier/adicionar_dispositivos.html'
...
class VisualizarDispositivo(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = DispositivoForm
    template_name = 'supplier/visualizar_dispositivos.html'
...
class ModificarDispositivo(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = DispositivoForm
    template_name = 'supplier/modificar_dispositivos.html'
...
class BorrarDispositivo(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = DispositivoForm
    template_name = 'supplier/borrar_dispositivos.html'
...
class Home(LoginRequiredMixin, View):
    '''
        ...
        '''
    template_name = 'supplier/home.html'
    def get(self, request):
        '''
...
class Proveedores(LoginRequiredMixin, View):
    '''
        ...
        '''
    template_name = 'supplier/proveedores.html'
    def get(self, request):
        '''
...
class Tecnicos(LoginRequiredMixin, View):
    ...
    template_name = 'supplier/tecnicos.html'
    def get(self, request):
        '''
...
class QuienesSomos(LoginRequiredMixin, View):
    ...
    template_name = 'supplier/quienes_somos.html'
    def get(self, request):
        '''
