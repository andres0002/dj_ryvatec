...
from apps.user.forms import UsuarioForm, CategoriaForm
...
class PerfilAdministrador(LoginRequiredMixin, View):
    ...
    '''
    login_url = '/'
    template_name = 'administrator/perfil_administrador.html'
...
class ListadoUsuarios(LoginRequiredMixin, View):
    ...
    login_url = '/'
    template_name = 'administrator/listar_usuarios.html'
    form_class = UsuarioForm
...
class AdicionarUsuario(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = UsuarioForm
    template_name = 'administrator/adicionar_usuarios.html'
...
class VisualizarUsuario(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = UsuarioForm
    template_name = 'administrator/visualizar_usuario.html'
...
class ModificarUsuario(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = UsuarioForm
    template_name = 'administrator/modificar_usuario.html'
...
class BorrarUsuario(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = UsuarioForm
    template_name = 'administrator/borrar_usuario.html'
...
class ListarCategoria(LoginRequiredMixin, View):
    ...
    template_name = 'administrator/listar_categoria.html'
...
class AdicionarCategoria(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = CategoriaForm
    template_name = 'administrator/adicionar_categoria.html'
...
class VisualizarCategoria(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = CategoriaForm
    template_name = 'administrator/visualizar_categoria.html'
...
class ModificarCategoria(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = CategoriaForm
    template_name = 'administrator/modificar_categoria.html'
...
class BorrarCategoria(LoginRequiredMixin, View):
    ...
    login_url = '/'
    form_class = CategoriaForm
    template_name = 'administrator/borrar_categoria.html'
...
class Proveedores(LoginRequiredMixin, View):
    ...
    template_name = 'administrator/proveedores.html'
    def get(self, request):
        '''
...
class Tecnicos(LoginRequiredMixin, View):
    ...
    template_name = 'administrator/tecnicos.html'
    def get(self, request):
        '''
...
class QuienesSomos(LoginRequiredMixin, View):
    ...
    template_name = 'administrator/quienes_somos.html'
    def get(self, request):
        '''
